...
packages.notUsed <- c("base64enc", "BiocManager", "formatR", "geosphere", "httpuv", "maps", 
                      "maptools", "mvtnorm", "proto", "RANN", "rasterVis", "rgdal", "rgeos", 
                      "RgoogleMaps", "rlang", "sampling", "seqinr", "SoDA", "spacetime", 
                      "stringi", "testthat", "usdm", "doParallel")
packages.basic <- c("base", "compiler", "graphics", "grDevices",   "methods", 
                    "parallel", "stats", "utils")
packages.CRAN <- c("ade4", "adegenet","car", "cowplot", "data.table", "deldir", 
                ...
                "RColorBrewer", "readr","rio", "rmarkdown", "secr","sf", "sp", "spatialEco", "spatialreg",
                "spdep", "spmoran", "Sunder", "terra", "tibble", "tmap", "tmaptools", "vcfR", "vegan")
packages.github <- c("gstudio", "popgraph", "QstFstComp", "lfmm")
packages.biocl <- c("qvalue", "LEA")
...
for(i in 2:length(b))
{
  if((b3[i] > 0) && (b3[-1] > 0)) b3[i] = b3[i-1] + 1
}
...
```{r custom}
custom.functions <- c("potential_offspring", "MLPE", "MLPEnoREML", "myPal", "method1", "method2", "method3", "method4", "myFunction", "myFunction.cmp", "createpops", "getArray", "getSunder")
```
