...
```
## Finished run: 1 out of 15. So far, it took: 0.45 sec.
## Finished run: 2 out of 15. So far, it took: 0.92 sec.
## Finished run: 3 out of 15. So far, it took: 1.36 sec.
## Finished run: 4 out of 15. So far, it took: 1.8 sec.
## Finished run: 5 out of 15. So far, it took: 2.23 sec.
## Finished run: 6 out of 15. So far, it took: 4.28 sec.
## Finished run: 7 out of 15. So far, it took: 6.31 sec.
## Finished run: 8 out of 15. So far, it took: 8.3 sec.
## Finished run: 9 out of 15. So far, it took: 10.28 sec.
## Finished run: 10 out of 15. So far, it took: 12.3 sec.
## Finished run: 11 out of 15. So far, it took: 15.95 sec.
## Finished run: 12 out of 15. So far, it took: 19.19 sec.
## Finished run: 13 out of 15. So far, it took: 22.39 sec.
## Finished run: 14 out of 15. So far, it took: 25.64 sec.
## Finished run: 15 out of 15. So far, it took: 28.83 sec.
```
...
##           read.csv(x) 4096.4500 4096.4500 4096.4500 4096.4500 4096.4500
##    readr::read_csv(x) 6029.1169 6029.1169 6029.1169 6029.1169 6029.1169
##  data.table::fread(x)  100.5918  100.5918  100.5918  100.5918  100.5918
##        rio::import(x)  184.4608  184.4608  184.4608  184.4608  184.4608
##        max neval
##  4096.4500     1
##  6029.1169     1
##   100.5918     1
...
##  read.csv(x) 4065.6517 4065.6517 4065.6517 4065.6517 4065.6517 4065.6517     1
##  read_csv(x) 3843.6103 3843.6103 3843.6103 3843.6103 3843.6103 3843.6103     1
##     fread(x)   67.1180   67.1180   67.1180   67.1180   67.1180   67.1180     1
##    import(x)   96.8817   96.8817   96.8817   96.8817   96.8817   96.8817     1
```
...
##      csv 69.9033 70.7781 76.11274 73.35855 78.5448  97.2844    10  b 
##    RData 18.0688 18.3992 18.95550 19.17695 19.3270  19.8203    10 a  
##      rds 16.6986 17.8516 18.75329 18.98610 19.5505  20.3896    10 a  
##  feather 74.7419 81.7279 87.38742 87.27380 89.2776 105.4103    10   c
```
...
## Unit: microseconds
##              expr  min    lq   mean median    uq    max neval cld
##      myFunction() 69.1 70.30 92.878   71.7 74.95 2028.0   100   a
##  myFunction.cmp() 69.1 70.25 73.093   71.3 74.80   90.9   100   a
```
...
<script type="application/json" data-for="htmlwidget-33de65d5df039931a737">{"x":{"message":{"prof":{"time":[1,1,2,2],"depth":[2,1,2,1],"label":[".External2","local",".External2","local"],"filenum":[null,null,null,null],"linenum":[null,null,null,null],"memalloc":[140.068473815918,140.068473815918,140.068473815918,140.068473815918],"meminc":[0,0,0,0],"filename":[null,null,null,null]},"interval":10,"files":[],"prof_output":"C:\\Users\\wagnerh1\\AppData\\Local\\Temp\\1\\RtmpWQrkO6\\file391045a77d2c.prof","highlight":{"output":["^output\\$"],"gc":["^<GC>$"],"stacktrace":["^\\.\\.stacktraceo(n|ff)\\.\\.$"]},"split":"h"}},"evals":[],"jsHooks":[]}</script>
```
...
<script type="application/json" data-for="htmlwidget-7ece7cccec775b3a474d">{"x":{"message":{"prof":{"time":[1,1,1,1,1,1],"depth":[6,5,4,3,2,1],"label":["tryCatch","profvis::profvis","eval","eval","eval.parent","local"],"filenum":[null,null,null,null,null,null],"linenum":[null,null,null,null,null,null],"memalloc":[139.79517364502,139.79517364502,139.79517364502,139.79517364502,139.79517364502,139.79517364502],"meminc":[0,0,0,0,0,0],"filename":[null,null,null,null,null,null]},"interval":10,"files":[],"prof_output":"C:/Users/wagnerh1/Desktop/LandGenCourse_book/output/output.prof","highlight":{"output":["^output\\$"],"gc":["^<GC>$"],"stacktrace":["^\\.\\.stacktraceo(n|ff)\\.\\.$"]},"split":"h"}},"evals":[],"jsHooks":[]}</script>
```
...
## Unit: milliseconds
##        expr      min       lq      mean    median       uq      max neval cld
##  method1(x)  35.7820  39.6190  66.30856  43.48395  63.7469 222.6225    10  a 
##  method2(x) 156.5110 184.3100 206.36702 190.19365 195.0680 349.1433    10   b
##  method3(x)  31.9453  36.4545  47.18849  39.00625  67.1420  77.0253    10  a 
##  method4(x)  38.1941  39.0678  44.84609  39.26755  40.7074  92.5543    10  a
```
