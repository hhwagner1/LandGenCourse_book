...
```
## Finished run: 1 out of 15. So far, it took: 0.39 sec.
## Finished run: 2 out of 15. So far, it took: 0.8 sec.
## Finished run: 3 out of 15. So far, it took: 1.23 sec.
## Finished run: 4 out of 15. So far, it took: 1.67 sec.
## Finished run: 5 out of 15. So far, it took: 2.06 sec.
## Finished run: 6 out of 15. So far, it took: 3.86 sec.
## Finished run: 7 out of 15. So far, it took: 5.61 sec.
## Finished run: 8 out of 15. So far, it took: 7.47 sec.
## Finished run: 9 out of 15. So far, it took: 9.39 sec.
## Finished run: 10 out of 15. So far, it took: 11.22 sec.
## Finished run: 11 out of 15. So far, it took: 14.42 sec.
## Finished run: 12 out of 15. So far, it took: 17.36 sec.
## Finished run: 13 out of 15. So far, it took: 20.28 sec.
## Finished run: 14 out of 15. So far, it took: 23.12 sec.
## Finished run: 15 out of 15. So far, it took: 26.09 sec.
```
...
## [65] "output"                   "README.md"               
## [67] "render1aa42eb27f36.rds"   "render1e541582584a.rds"  
...
##           read.csv(x) 6094.8450 6094.8450 6094.8450 6094.8450 6094.8450
##    readr::read_csv(x) 3726.2651 3726.2651 3726.2651 3726.2651 3726.2651
##  data.table::fread(x)  171.3114  171.3114  171.3114  171.3114  171.3114
##        rio::import(x)  346.3606  346.3606  346.3606  346.3606  346.3606
##        max neval
##  6094.8450     1
##  3726.2651     1
##   171.3114     1
...
##  read.csv(x) 6120.7635 6120.7635 6120.7635 6120.7635 6120.7635 6120.7635     1
##  read_csv(x) 5101.4360 5101.4360 5101.4360 5101.4360 5101.4360 5101.4360     1
##     fread(x)   62.7644   62.7644   62.7644   62.7644   62.7644   62.7644     1
##    import(x)   82.1713   82.1713   82.1713   82.1713   82.1713   82.1713     1
```
...
##      csv 63.8632 64.0169 67.21322 65.66955 68.3636 80.5900    10  b 
##    RData 14.7535 15.6913 15.88254 15.76605 16.3019 17.4753    10 a  
##      rds 14.7968 15.1298 16.57644 16.03185 17.0104 22.1672    10 a  
##  feather 62.8765 66.8230 73.29569 71.01410 79.8098 88.1941    10   c
```
...
## Unit: microseconds
##              expr    min      lq     mean median      uq      max neval cld
##      myFunction() 51.701 53.1000 70.05902 53.601 54.3010 1483.601   100   a
##  myFunction.cmp() 51.801 52.9015 55.50092 53.501 54.2505  125.401   100   a
```
...
<script type="application/json" data-for="htmlwidget-33de65d5df039931a737">{"x":{"message":{"prof":{"time":[1,1,1,1,1,1,2,2,3,3],"depth":[6,5,4,3,2,1,2,1,2,1],"label":["Rprof","profvis::profvis","eval","eval","eval.parent","local",".External2","local",".External2","local"],"filenum":[null,null,null,null,null,null,null,null,null,null],"linenum":[null,null,null,null,null,null,null,null,null,null],"memalloc":[139.725601196289,139.725601196289,139.725601196289,139.725601196289,139.725601196289,139.725601196289,140.066200256348,140.066200256348,140.066200256348,140.066200256348],"meminc":[0,0,0,0,0,0,0.340599060058594,0,0,0],"filename":[null,null,null,null,null,null,null,null,null,null]},"interval":10,"files":[],"prof_output":"C:\\Users\\wagnerh1\\AppData\\Local\\Temp\\1\\Rtmp2tIAZm\\file2ff820204d43.prof","highlight":{"output":["^output\\$"],"gc":["^<GC>$"],"stacktrace":["^\\.\\.stacktraceo(n|ff)\\.\\.$"]},"split":"h"}},"evals":[],"jsHooks":[]}</script>
```
...
<script type="application/json" data-for="htmlwidget-7ece7cccec775b3a474d">{"x":{"message":{"prof":{"time":[1,1,1,1,1,1],"depth":[6,5,4,3,2,1],"label":["tryCatch","profvis::profvis","eval","eval","eval.parent","local"],"filenum":[null,null,null,null,null,null],"linenum":[null,null,null,null,null,null],"memalloc":[139.793228149414,139.793228149414,139.793228149414,139.793228149414,139.793228149414,139.793228149414],"meminc":[0,0,0,0,0,0],"filename":[null,null,null,null,null,null]},"interval":10,"files":[],"prof_output":"C:/Users/wagnerh1/Desktop/LandGenCourse_book/output/output.prof","highlight":{"output":["^output\\$"],"gc":["^<GC>$"],"stacktrace":["^\\.\\.stacktraceo(n|ff)\\.\\.$"]},"split":"h"}},"evals":[],"jsHooks":[]}</script>
```
...
## Unit: milliseconds
##        expr      min       lq      mean    median       uq      max neval cld
##  method1(x)  31.6935  32.5446  38.34423  36.10670  38.2989  62.2452    10  a 
##  method2(x) 140.3605 144.4418 160.13771 155.73305 173.7075 198.8456    10   b
##  method3(x)  30.4043  32.2350  38.34638  33.52005  40.9148  56.1110    10  a 
##  method4(x)  31.2790  33.0671  34.64684  33.87860  34.4874  43.8446    10  a
```
