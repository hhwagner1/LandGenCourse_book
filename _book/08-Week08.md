...
## Finished run: 2 out of 15. So far, it took: 0.9 sec.
## Finished run: 3 out of 15. So far, it took: 1.37 sec.
## Finished run: 4 out of 15. So far, it took: 1.83 sec.
## Finished run: 5 out of 15. So far, it took: 2.28 sec.
## Finished run: 6 out of 15. So far, it took: 4.37 sec.
## Finished run: 7 out of 15. So far, it took: 6.4 sec.
## Finished run: 8 out of 15. So far, it took: 8.48 sec.
## Finished run: 9 out of 15. So far, it took: 10.55 sec.
## Finished run: 10 out of 15. So far, it took: 12.61 sec.
## Finished run: 11 out of 15. So far, it took: 16.37 sec.
## Finished run: 12 out of 15. So far, it took: 20.05 sec.
## Finished run: 13 out of 15. So far, it took: 23.33 sec.
## Finished run: 14 out of 15. So far, it took: 26.84 sec.
## Finished run: 15 out of 15. So far, it took: 30.4 sec.
```
...
## [69] "render2160611f35e6.rds"   "render23ec66f4ddd.rds"   
## [71] "render2fbc1ad7f46.rds"    "render2fd81ad75275.rds"  
## [73] "render33ed6170c2e4.rds"   "render363c1997640c.rds"  
## [75] "render3894c561f3.rds"     "render3b305196d38.rds"   
## [77] "rendera1ac36509ec1.rds"   "renderf9011b67ac.rds"    
## [79] "rsconnect"                "style.css"               
## [81] "toc.css"                  "tutorials"               
## [83] "vignettes"                "Week8_bonus_vignette.R"  
...
##           read.csv(x) 4472.1244 4472.1244 4472.1244 4472.1244 4472.1244
##    readr::read_csv(x) 4255.9298 4255.9298 4255.9298 4255.9298 4255.9298
##  data.table::fread(x)   93.0697   93.0697   93.0697   93.0697   93.0697
##        rio::import(x)  175.3591  175.3591  175.3591  175.3591  175.3591
##        max neval
##  4472.1244     1
##  4255.9298     1
##    93.0697     1
...
##  read.csv(x) 4542.8751 4542.8751 4542.8751 4542.8751 4542.8751 4542.8751     1
##  read_csv(x) 4195.2045 4195.2045 4195.2045 4195.2045 4195.2045 4195.2045     1
##     fread(x)   73.7162   73.7162   73.7162   73.7162   73.7162   73.7162     1
##    import(x)   87.0263   87.0263   87.0263   87.0263   87.0263   87.0263     1
```
...
##      csv 70.8258 77.2168 83.82816 80.06050 90.0830 104.9126    10   b
##    RData 17.2855 18.2365 20.96298 20.00165 21.6841  28.9362    10  a 
##      rds 16.8213 17.2896 19.66174 18.06585 19.9639  27.6797    10  a 
##  feather 80.4690 81.4114 91.59502 89.09280 92.5548 130.6794    10   b
```
...
## Unit: microseconds
##              expr  min    lq   mean median    uq    max neval cld
##      myFunction() 58.7 65.40 85.637  67.55 68.90 1714.8   100   a
##  myFunction.cmp() 58.4 63.15 70.315  67.25 68.65  130.3   100   a
```
...
<script type="application/json" data-for="htmlwidget-33de65d5df039931a737">{"x":{"message":{"prof":{"time":[1,1,1,1,1,1,2,2,3,3],"depth":[6,5,4,3,2,1,2,1,2,1],"label":["Rprof","profvis::profvis","eval","eval","eval.parent","local",".External2","local",".External2","local"],"filenum":[null,null,null,null,null,null,null,null,null,null],"linenum":[null,null,null,null,null,null,null,null,null,null],"memalloc":[139.727897644043,139.727897644043,139.727897644043,139.727897644043,139.727897644043,139.727897644043,140.068496704102,140.068496704102,140.068496704102,140.068496704102],"meminc":[0,0,0,0,0,0,0.340599060058594,0,0,0],"filename":[null,null,null,null,null,null,null,null,null,null]},"interval":10,"files":[],"prof_output":"C:\\Users\\wagnerh1\\AppData\\Local\\Temp\\1\\Rtmpag8iPM\\file38f43f2941a0.prof","highlight":{"output":["^output\\$"],"gc":["^<GC>$"],"stacktrace":["^\\.\\.stacktraceo(n|ff)\\.\\.$"]},"split":"h"}},"evals":[],"jsHooks":[]}</script>
```
...
<script type="application/json" data-for="htmlwidget-7ece7cccec775b3a474d">{"x":{"message":{"prof":{"time":[1,1,1,1,1,1],"depth":[6,5,4,3,2,1],"label":["Rprof","profvis::profvis","eval","eval","eval.parent","local"],"filenum":[null,null,null,null,null,null],"linenum":[null,null,null,null,null,null],"memalloc":[139.795524597168,139.795524597168,139.795524597168,139.795524597168,139.795524597168,139.795524597168],"meminc":[0,0,0,0,0,0],"filename":[null,null,null,null,null,null]},"interval":10,"files":[],"prof_output":"C:/Users/wagnerh1/Desktop/LandGenCourse_book/output/output.prof","highlight":{"output":["^output\\$"],"gc":["^<GC>$"],"stacktrace":["^\\.\\.stacktraceo(n|ff)\\.\\.$"]},"split":"h"}},"evals":[],"jsHooks":[]}</script>
```
...
## Unit: milliseconds
##        expr      min       lq      mean    median       uq      max neval cld
##  method1(x)  37.3817  37.9906  43.21914  41.79165  44.8550  62.3942    10  a 
##  method2(x) 161.3407 166.8091 186.89693 187.16930 194.4122 244.8515    10   b
##  method3(x)  35.6583  37.9399  43.97387  39.04420  44.1965  67.3908    10  a 
##  method4(x)  36.2691  37.6186  39.13317  38.41325  39.6894  44.4623    10  a
```
