...
## Finished run: 2 out of 15. So far, it took: 0.67 sec.
## Finished run: 3 out of 15. So far, it took: 0.98 sec.
## Finished run: 4 out of 15. So far, it took: 1.28 sec.
## Finished run: 5 out of 15. So far, it took: 1.59 sec.
## Finished run: 6 out of 15. So far, it took: 2.92 sec.
## Finished run: 7 out of 15. So far, it took: 4.3 sec.
## Finished run: 8 out of 15. So far, it took: 5.62 sec.
## Finished run: 9 out of 15. So far, it took: 6.94 sec.
## Finished run: 10 out of 15. So far, it took: 8.16 sec.
## Finished run: 11 out of 15. So far, it took: 10.38 sec.
## Finished run: 12 out of 15. So far, it took: 12.93 sec.
## Finished run: 13 out of 15. So far, it took: 15.13 sec.
## Finished run: 14 out of 15. So far, it took: 17.35 sec.
## Finished run: 15 out of 15. So far, it took: 19.6 sec.
```
...
## [37] "10-Week10.knit.md"        "10-Week10.Rmd"           
## [39] "11-Week11_files"          "11-Week11.Rmd"           
## [41] "12-Week12_files"          "12-Week12.Rmd"           
## [43] "13-Week13_files"          "13-Week13.Rmd"           
## [45] "14-Week14_files"          "14-Week14.knit.md"       
## [47] "14-Week14.Rmd"            "404.html"                
## [49] "book.bib"                 "ChapterDepot.R"          
## [51] "data"                     "downloads"               
## [53] "header.html"              "index.md"                
## [55] "index.Rmd"                "js"                      
## [57] "LandGenCourse_book.rds"   "LandGenCourse_book.Rproj"
## [59] "LICENSE"                  "ListOfPackages.nb.html"  
## [61] "ListOfPackages.Rmd"       "my_plot.png"             
## [63] "output"                   "README.md"               
## [65] "render1b7c27bb24ce.rds"   "render1e541582584a.rds"  
## [67] "render23ec66f4ddd.rds"    "render2fbc1ad7f46.rds"   
## [69] "render2fd81ad75275.rds"   "render33ed6170c2e4.rds"  
## [71] "render363c1997640c.rds"   "render3894c561f3.rds"    
## [73] "render3b305196d38.rds"    "render65e32e6edd81.rds"  
## [75] "render65ea2d72427d.rds"   "render68a77156eab9.rds"  
## [77] "render704659ccfe92.rds"   "rendera1ac36509ec1.rds"  
## [79] "renderb74a25ab009f.rds"   "renderf9011b67ac.rds"    
## [81] "rsconnect"                "search_index.json"       
## [83] "style.css"                "toc.css"                 
## [85] "tutorials"                "vignettes"               
## [87] "Week1_vignette.R"         "Week2_bonus_vignette.R"  
## [89] "Week8_bonus_vignette.R"   "Workflow.nb.html"        
## [91] "Workflow.Rmd"
```
...
## Unit: milliseconds
##                                        expr        min         lq       mean
##                                 read.csv(x) 2058.49172 2058.49172 2058.49172
##  readr::read_csv(x, show_col_types = FALSE) 1632.54923 1632.54923 1632.54923
##                        data.table::fread(x)  129.41843  129.41843  129.41843
##                              rio::import(x)   86.14063   86.14063   86.14063
##      median         uq        max neval
##  2058.49172 2058.49172 2058.49172     1
##  1632.54923 1632.54923 1632.54923     1
##   129.41843  129.41843  129.41843     1
##    86.14063   86.14063   86.14063     1
```
...
## Unit: milliseconds
##                                 expr        min         lq       mean
##                          read.csv(x) 2090.19099 2090.19099 2090.19099
##  read_csv(x, show_col_types = FALSE) 1519.59169 1519.59169 1519.59169
##                             fread(x)   80.90583   80.90583   80.90583
##                            import(x)   82.89298   82.89298   82.89298
##      median         uq        max neval
##  2090.19099 2090.19099 2090.19099     1
##  1519.59169 1519.59169 1519.59169     1
##    80.90583   80.90583   80.90583     1
##    82.89298   82.89298   82.89298     1
```
...
##      csv  105.22634  105.92120  106.53729  106.70010  107.31873  107.38257
##    RData   16.69569   16.95194   17.40926   17.35395   17.49876   19.06758
##      rds   16.48790   17.07531   17.83732   17.41200   17.97440   20.31944
##  feather 3158.17313 3219.87781 3677.74819 3676.90452 3871.87940 4450.51052
##  neval cld
##     10  a 
##     10  a 
##     10  a 
...
##      myFunction() 29.192 30.381 43.95692 30.8525 31.4470 1321.963   100   a
##  myFunction.cmp() 29.479 30.463 31.20141 30.9960 31.3445   55.186   100   a
```
...
<script type="application/json" data-for="htmlwidget-8200f0838a0312caa364">{"x":{"message":{"prof":{"time":[1,2,3,3,4,4,4,4,5,5],"depth":[1,1,2,1,4,3,2,1,2,1],"label":["rnorm","rnorm","na.omit.data.frame","model.frame.default","anyDuplicated.default","[.data.frame","na.omit.data.frame","model.frame.default","lm.fit","lm"],"filenum":[null,null,null,null,null,null,null,null,null,null],"linenum":[null,null,null,null,null,null,null,null,null,null],"memalloc":[169.5002670288086,173.3149642944336,179.0446166992188,179.0446166992188,209.7482299804688,209.7482299804688,209.7482299804688,209.7482299804688,238.3619689941406,238.3619689941406],"meminc":[0,3.814697265625,5.729652404785156,0,30.70361328125,0,0,0,28.61373901367188,0],"filename":[null,null,null,null,null,null,null,null,null,null]},"interval":10,"files":[],"prof_output":"/var/folders/xf/gplbp61n2dx53pwn1m8rcgj00000gn/T//Rtmpr94svW/file72c07c9f6ab0.prof","highlight":{"output":["^output\\$"],"gc":["^<GC>$"],"stacktrace":["^\\.\\.stacktraceo(n|ff)\\.\\.$"]},"split":"h"}},"evals":[],"jsHooks":[]}</script>
```
...
##  method1(x)  27.79862  28.44924  29.43319  29.52863  30.30031  30.76624    10
##  method2(x) 156.89728 161.93426 186.91294 168.53230 221.73768 227.91224    10
##  method3(x)  41.56949  43.24606  55.27686  43.91123  46.58621 106.24925    10
##  method4(x)  41.68183  42.95299  44.03750  43.91789  44.43539  47.07591    10
##  cld
##  a  
##   b 
##    c
