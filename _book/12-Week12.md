...
Caren Goldberg and Helene Wagner
...
![Map of study area](/Users/helene/Desktop/Github_Projects/LandGenCourse_book/vignettes/WE12_Fig1.png)
...
<img src="12-Week12_files/figure-html/unnamed-chunk-13-1.png" alt="" width="672" />
...
<img src="12-Week12_files/figure-html/unnamed-chunk-14-1.png" alt="" width="672" />
...
``` r
## d. <- df[order(df$site, df$pop1, df$pop2),]
```
...
## a.f(resid(m1, type='normalized')) ## Autocorrelation function
```
...
## a.f(resid(m2, type='normalized')) ## Autocorrelation function
```
