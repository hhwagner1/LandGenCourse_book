...
For a visual explanation of projections and coordinate systems, see:
...
<img src="02-Week02_files/figure-html/unnamed-chunk-22-1.png" width="768" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-24-1.png" width="427.2" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-43-1.png" width="672" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-45-1.png" width="427.2" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-48-1.png" width="768" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-59-1.png" width="672" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-60-1.png" width="672" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-61-1.png" width="672" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-62-1.png" width="672" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-63-1.png" width="672" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-66-1.png" width="672" />
...
```
## Map saved to /Users/hhwagner1/Desktop/R_GitHub_Projects/LandGenCourse_book/output/StaticMap.png
```

```
## Resolution: 808.1867 by 2100 pixels
```

```
## Size: 2.693956 by 7 inches (300 dpi)
```
...
- We use `as.factor` to tell R that this is a categorical raster layer. This is necessary because the values are coded numerically with values between 11 - 95.
...
- R created a column ID. With categorical rasters, terra always numbers levels starting with 0. The ID zero here refers to missing values
- The column nlcd contains the land cover categories. Note that terra concluded that there must be values from 1 - 95 and thus created as many categories, but only the codes actually present in the raster are listed (11, 12, 31, 42, 52, 71, 90, 95).
...
This list has more entries (e.g., 21-24) than we need, because not all US land cover classes occur in the study area. We need to make sure the colors and cover types are stored as 'character', because the missing factor levels would later create problems.
...
We merge this list with the raster attribute table of `NLCD.terra`. Le'ts print only the rows with values in column `nlcd`:
...
```
##   ID nlcd   color                    attribute
## 1 11   11 #456DA8                   Open Water
## 2 12   12 #E6EEF9           Perennial Ice/Snow
## 3 31   31 #B2AEA3 Barren Land (Rock/Sand/Clay)
## 4 42   42 #16692E             Evergreen Forest
## 5 52   52 #D5B883                  Shrub/Scrub
## 6 71   71 #EDEFCA         Grassland/Herbaceous
## 7 90   90 #BED8F6               Woody Wetlands
## 8 95   95 #6EA5C4 Emergent Herbaceous Wetlands
```
...
<img src="02-Week02_files/figure-html/unnamed-chunk-77-1.png" width="672" />
...
<img src="02-Week02_files/figure-html/unnamed-chunk-78-1.png" width="672" />
...
```
## Map saved to /Users/hhwagner1/Desktop/R_GitHub_Projects/LandGenCourse_book/output/RasterMap.pdf
```
