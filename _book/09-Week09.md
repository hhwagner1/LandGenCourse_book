...
## -2.7695 -0.7136 -0.0198  0.7221  3.0550 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  -3.6874     0.1790  -20.60   <2e-16 ***
## p1            7.4272     0.3242   22.91   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.107 on 198 degrees of freedom
## Multiple R-squared:  0.7261,	Adjusted R-squared:  0.7247 
## F-statistic: 524.8 on 1 and 198 DF,  p-value: < 2.2e-16
```
...
## 
## Least-square error: 722728.965602
