...
## -2.6420 -0.8105 -0.0512  0.8546  3.8711 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   3.8508     0.1822   21.14   <2e-16 ***
## p1           -7.8107     0.3356  -23.28   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.08 on 198 degrees of freedom
## Multiple R-squared:  0.7324,	Adjusted R-squared:  0.731 
## F-statistic: 541.8 on 1 and 198 DF,  p-value: < 2.2e-16
```
...
## 
## Least-square error: 722698.001314
