...
## -2.6759 -0.7122 -0.1293  0.7822  3.6469 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  -3.8387     0.1680  -22.85   <2e-16 ***
## p1            7.6129     0.2992   25.45   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.045 on 198 degrees of freedom
## Multiple R-squared:  0.7658,	Adjusted R-squared:  0.7646 
## F-statistic: 647.4 on 1 and 198 DF,  p-value: < 2.2e-16
```
...
## 
## Least-square error: 722698.114437
