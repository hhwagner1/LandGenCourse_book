...
- External link: [Week 4 video (Part 1)](https://play.library.utoronto.ca/watch/f6d9e3e8b341efdc63ec43cc59050312);  [Week 4 video (Part 2)](https://play.library.utoronto.ca/watch/516a408cced5cb70ea55513ccb205475)
- Transcript: [Download transcript](https://github.com/hhwagner1/DGS_LG_Labs/raw/master/transcripts/Week4_script_v3.pdf)


### Video, Part 1 {-}

<iframe width="560" height="315" src="https://play.library.utoronto.ca/embed/f6d9e3e8b341efdc63ec43cc59050312" frameborder="0" allowfullscreen> iframe not supported </iframe>
...
<img src="04-Week04_files/figure-html/unnamed-chunk-1-1.png" alt="" width="768" />
...
## 1  Variations within samples 4.42799478 -83.294544    less  0.001
## 2 Variations between samples 0.50644882  56.488569 greater  0.001
## 3 Variations between Cluster 0.02770227   1.786349 greater  0.039
```
...
<img src="04-Week04_files/figure-html/unnamed-chunk-17-1.png" alt="" width="768" />
...
## (Intercept)  2.181e-16  1.535e-01   0.000  1.00000   
...
Here's a link to a great resource about the interpretation of these plots generated by R: http://stratigrafia.org/8370/rtips/regressionPlots.html
...
<img src="04-Week04_files/figure-html/unnamed-chunk-19-1.png" alt="" width="768" />
...
## fill.scale = tm_scale(<HERE>).[v3->v4] `tm_bubbles()`: use 'fill' for the fill color of polygons/symbols
## (instead of 'col'), and 'col' for the outlines (instead of 'border.col').[v3->v4] `tm_text()`: migrate the layer options 'just' to 'options =
## opt_tm_text(<HERE>)'
```
...
<img src="04-Week04_files/figure-html/unnamed-chunk-22-1.png" alt="" width="672" />
...
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)   
## (Intercept)  5.498e-16  1.562e-01   0.000  1.00000   
...
<img src="04-Week04_files/figure-html/unnamed-chunk-26-1.png" alt="" width="768" />
...
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)   
## (Intercept) -3.963e-16  1.441e-01   0.000  1.00000   
...
<img src="04-Week04_files/figure-html/unnamed-chunk-29-1.png" alt="" width="768" />
...
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)   
## (Intercept) -5.456e-16  1.486e-01   0.000  1.00000   
...
<img src="04-Week04_files/figure-html/unnamed-chunk-31-1.png" alt="" width="768" />
