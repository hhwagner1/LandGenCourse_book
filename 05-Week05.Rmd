...
Path=paste0(here::here(), "/downloads/Week5_Slides/")
...
```{r echo=FALSE}
library(kableExtra)
Table <- readRDS(paste0(here::here(), "/output/table_list.rds"))[[5]]
Table %>% kable() %>% 
...
```{r child=paste0(here::here(), "/vignettes/", "Week5_vignette.Rmd"), echo=TRUE}
```
