...
Path=paste0(here::here(), "/downloads/Week3_Slides/")
...
```{r echo=FALSE}
library(kableExtra)
Table <- readRDS(paste0(here::here(), "/output/table_list.rds"))[[3]]
Table %>% kable() %>% 
...
rmd_file <- paste0(here::here(), "/vignettes/", "Week3_vignette.Rmd")
