...
```{r echo=FALSE, fig.height=72, fig.width=8, message=FALSE}
library(cowplot)
library(ggplot2)

Path=paste0(here::here(), "/downloads/Week4_Slides/")
...
```{r echo=FALSE}
library(kableExtra)
Table <- readRDS(paste0(here::here(), "/output/table_list.rds"))[[4]]
Table %>% kable() %>% 
...
rmd_file <- paste0(here::here(), "/vignettes/", "Week4_vignette.Rmd")
